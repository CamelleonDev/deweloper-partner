...
echo "  - Start command: /usr/local/bin/entrypoint-worker.sh"
echo ""
echo "Cron service — Settings:"
echo "  - Cron Schedule: leave EMPTY (not Railway cron — min 5 min)"
echo "  - Start command: /usr/local/bin/entrypoint-cron.sh"
echo ""
